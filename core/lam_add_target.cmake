...
function(lam_add_target name)
  ...
  set(options isLIB isINTERFACE APPEND_SOURCE EXCLUDE_FROM_ALL SHARED STATIC OBJECT)
  ...
  if (arg_APPEND_SOURCE)
    ...
    lam_assert_falsy(
      arg_isLIB arg_isINTERFACE arg_EXCLUDE_FROM_ALL arg_SHARED arg_STATIC arg_OBJECT
    )
  else()
  ...
  if (arg_isINTERFACE)
    lam_assert_falsy(arg_STATIC arg_isLIB arg_SHARED arg_APPEND_SOURCE arg_OBJECT)
  endif()
  if (arg_STATIC)
    lam_assert_falsy(arg_isINTERFACE arg_SHARED arg_OBJECT arg_APPEND_SOURCE)
  endif()
  if (arg_SHARED)
    lam_assert_falsy(arg_isINTERFACE arg_STATIC arg_OBJECT arg_APPEND_SOURCE)
  endif()
  if (arg_OBJECT)
    lam_assert_falsy(arg_isINTERFACE arg_STATIC arg_SHARED arg_APPEND_SOURCE)
  endif()
  ...
  elseif (arg_OBJECT)
    add_library(${name} OBJECT ${arg_SRCS})
  ...
  foreach(args IN LISTS command_args)
    if (DEFINED ${args})
      ...
      if (${FIRST_ARG} STREQUAL PUBLIC OR
        ...
        elseif(arg_isLIB OR arg_STATIC OR arg_SHARED OR arg_OBJECT)
