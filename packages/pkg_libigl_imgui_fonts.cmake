...
if (NOT ${libigl_imgui_fonts_VERSION} STREQUAL "")
  message(FATAL_ERROR "[package/libigl-imgui] does not support version selection.")
endif()
...
require_package(libigl_imgui "gh:libigl/libigl-imgui#${libigl_imgui_fonts_TAG}" DOWNLOAD_ONLY YES)
